...
// ========================
// DATA MOCK RAWAT INAP (SAMA SEPERTI SEBELUMNYA)
// ========================
const mockRawatInap = [
  {
    no_rm: '374608',
...
// Helper untuk menentukan kelas berdasarkan ruangan
...
app.get('/', (req, res) => {
  res.json({
    ...
    contoh: [
      ...
      'http://localhost:3000/api/okupansi-kamar',
      'http://localhost:3000/api/kamar-status?status_kamar=1',
      'http://localhost:3000/api/kamar-status?kode_ruangan=RG01'
    ]
  });
});
...
app.listen(PORT, () => {
  ...
  ✅ ENDPOINTS OKUPANSI KAMAR (DARI TABEL):
  7. GET /api/okupansi-kamar
  8. GET /api/kamar-status?status_kamar=0&kode_ruangan=RG01
